...
namespace DataLibrary
{
    public class TransactionOperation
    {
        ...
        public TransactionOperation(int originAccount, int destinationAccount, decimal amount)
        {
        ...
        public Task<bool> ExecuteTransaction(bool commit, int delayEndTransaction, IsolationLevel level, string TransactionName)
        {
            return Task<bool>.Run(() =>
            {
                ...
                // Preparar para leer la disponiblidad de dinero en origen
                ...
                // Crear la transacción y se alista con eso el comando
