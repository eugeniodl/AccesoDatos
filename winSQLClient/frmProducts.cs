    ...
    "Products ORDER BY UnitPrice DESC;";
        ...
        private void InsertProducts()
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    string queryString = "INSERT INTO Products(ProductName, UnitPrice) " +
                        "VALUES('" + txtProductName.Text + "', " + txtUnitPrice.Text + ")";
            ...
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                try
                {
                    string queryString = "UPDATE Products SET ProductName = '" +
                        txtProductName.Text + "', UnitPrice = " + txtUnitPrice.Text +
